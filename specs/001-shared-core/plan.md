...
Constitution Principle II requires acceptance tests before implementation. [tasks.md](./tasks.md) enforces this per user story:

| Phase | Tests first (MUST FAIL) | Then implement |
|-------|-------------------------|----------------|
| US1 Export | T014, T015 | T016–T018 |
| US2 Adjudication scoring | T020 | T021–T023 |
| US3 Adversarial rates (minimal) | T024 | T025–T027 |
| US6 Context tiers | T028 | T029–T031 |
| US5 Cache | T032 | T033–T037 |
| US4 Model seam | T038 | T039–T042 |
...
Generated by `/speckit-tasks` → [tasks.md](./tasks.md) (next step).
...
3. **Test-first per module**: export → provenance → scoring → context → cache → model seam (seam last; depends on context types).
